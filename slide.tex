...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item Overleaf项目地址位于 \url{https://www.ovqmzndvwyb}，可以直接使用
...
\begin{frame}
    \begin{itemize}
        ...
        \item 本模板在Trinkle23897的THU-Beamer-Theme基础上修改而成，感谢Trinkle23897同学！\href{https://github.com/Trinkle23897/THU-Beamer-Theme}{\color{blue}{戳我}}
    \end{itemize}
\end{frame}
